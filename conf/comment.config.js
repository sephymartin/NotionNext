...
module.exports = {
  ...
  COMMENT_TWIKOO_CDN_URL:
    ...
    'https://gcore.jsdelivr.net/npm/twikoo@1.6.17/dist/twikoo.all.min.js', // twikoo客户端cdn
  ...
  COMMENT_GITALK_JS_CDN_URL:
    ...
    'https://gcore.jsdelivr.net/npm/gitalk@1/dist/gitalk.min.js', // gitalk客户端 js cdn
  COMMENT_GITALK_CSS_CDN_URL:
    process.env.NEXT_PUBLIC_COMMENT_GITALK_CSS_CDN_URL ||
    'https://gcore.jsdelivr.net/npm/gitalk@1/dist/gitalk.css', // gitalk客户端 css cdn
